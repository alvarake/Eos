...
service.register("loadmediaSound", function(message) {
	service.call("luna://com.webos.media/load", {"uri": "https://media.w3.org/2010/05/sintel/trailer.mp4","type": "media","payload": {"option": {"appId": "eos"}}}, function(m2) {
		var response = "You appear to have your locale set to: " ;
		console.log(response);
		message.respond({message: response});
	});
});

service.register("playmediaSound", function(message) {
	service.call("luna://com.webos.media/play", {"uri": "https://media.w3.org/2010/05/sintel/trailer.mp4","type": "media","payload": {"option": {"appId": "eos"}}}, function(m2) {
